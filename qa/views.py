...
class QuestionIndexView(ListView):
    ...
    def get_queryset(self):
        print("3oooooooo")
        queryset = super(QuestionIndexView, self).get_queryset().filter(courseNo__courseNo=self.kwargs['course_No'])\
            .select_related('user')\
            .annotate(num_answers=Count('answer', distinct=True),
                      num_question_comments=Count('questioncomment',
                      distinct=True))
...
class QuestionsByTagView(ListView):
    ...
    def get_queryset(self, **kwargs):
        print("5oooooooo")
        return Question.objects.filter(tags__slug=self.kwargs['tag'], courseNo='CS103')
...
class CreateQuestionView(LoginRequired, CreateView):
    ...
    def form_valid(self, form):
        ...
        """
        print("8oooooooo")
        form.instance.courseNo = Courses.objects.get(courseNo=self.kwargs['course_No'])
...
class UpdateQuestionView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'],'pk': question.pk})
        return url
...
class CreateAnswerView(LoginRequired, CreateView):
    ...
    def get_success_url(self):
        ...
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'],'pk': self.kwargs['question_id']})
        return url
...
class UpdateAnswerView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'],'pk': answer.question.pk})
        return url
...
class CreateAnswerCommentView(LoginRequired, CreateView):
    ...
    def get_success_url(self):
        ...
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'],'pk': question_pk})
        return url
...
class UpdateQuestionCommentView(LoginRequired,
    ...
    def get_success_url(self):
        ...
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'], 'pk': question_comment.question.pk})
        return url
...
class UpdateAnswerCommentView(UpdateQuestionCommentView):
    ...
    def get_success_url(self):
        ...
        print("14oooooooo")
        url = reverse('qa_detail', kwargs={'course_No': self.kwargs['course_No'], 'pk': answer_comment.answer.question.pk})
        return url
...
class QuestionDetailView(HitCountDetailView):
    ...
    def get(self, request, **kwargs):
        ...
        if slug != my_object.slug:
            ...
            url = reverse('qa_detail', kwargs=kwargs)
            return url
